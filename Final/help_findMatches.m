...
function [match1, match2] = help_findMatches(im1, im2, threshold_dist, thresh_harris)
    
    im1 = rgb2gray(im1);
    im2 = rgb2gray(im2);

    % Find features and make descriptor of image 1
    loc1                  = help_DoG(im1, 0.01);
    [r1, c1, sigma1]      = help_harris(im1, loc1, thresh_harris, 0);
    ...
    loc2                  = help_DoG(im2, 0.01);
    [r2, c2, sigma2]      = help_harris(im2, loc2, thresh_harris, 0);
