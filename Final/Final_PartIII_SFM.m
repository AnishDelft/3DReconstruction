function [Clouds, M1, MeanFrame1, Img1] = Final_PartIII_SFM(PV,C ,project_name, img_dir, img_type, part3_frame, verbose, plot)
    M1         = [];
    MeanFrame1 = [];
    Img1       = [];
    ...
    for i = iArray 
        ...
        if (1)
            ...
            if i==(numFrames + 1 - part3_frame) && ~p
                M1         = M(1:2,:); % [2,3]
                MeanFrame1 = sum(X_3D_local(1:2,:),2)/numPoints; %[2,1]
                imgname1   = strcat(img_dir, Files(part3_frame).name);
