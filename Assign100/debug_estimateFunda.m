...
% tmp = load('Data/castle/funda_data/estimateFunda_castle_round6.mat');
tmp = load('Data/teddy/funda_data/estimateFunda_teddy_round1.mat');
threshold = 50;
...
debug_ransac(tmp.name1, tmp.name2, F, inliers, 'data/teddy/TeddyBearPNG/', X1, X2, tmp.match);
