function [mergedCloud] = Final_PartIV_PCStitching(CloudsOld, PV, verbose)
    ...
    mergedColors                  = zeros(3, size(PV,2));
    mergedColors(:, Clouds{1}{3}) = Clouds{1}{4}; 
    ...
    for i = 2:numClouds
        ...
        mergedColors(:, iNew)      = Clouds{i}{4}(:,iCloudsNew');
    ...
    if (1)
        ...
        scatter3(mergedCloud(1,:)', mergedCloud(2,:)', mergedCloud(3,:)', 20, mergedColors'./255, 'filled');
