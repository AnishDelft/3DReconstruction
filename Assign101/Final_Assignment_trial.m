...
if (1)
    ...
    part3_imgdir     = part1_inputDir;
    part3_img_type   = '*.png';
    
    part1_feattype        = 'harris_cvteam'; % ['cvteam', 'kaze', 'harris', 'harris_matlab', 'harris_cvteam']
    part1_matchThreshold  = 1.5;
...
if (bool_extractFeatures)
    fprintf('\n  --> Extracting Features (%s) from images', part1_feattype);
else
